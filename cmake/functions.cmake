...
function(generate_lib_src_list LIB_SOURCES)
         ...
         if(BUILD_FIPS_V2)
              ...
              if(BUILD_AES)
                   ...
                   if(BUILD_ARMASM AND BUILD_FIPS_READY)
                        ...
                        list(APPEND LIB_SOURCES wolfcrypt/src/port/arm/armv8-32-aes-asm_c.c)
                        list(APPEND LIB_SOURCES wolfcrypt/src/port/arm/armv8-32-aes-asm.S)
                   endif()
              endif()
    ...
    if(NOT BUILD_FIPS_RAND)
         ...
         if(BUILD_WC_KYBER)
              ...
              elseif(BUILD_ARMASM)
                   list(APPEND LIB_SOURCES wolfcrypt/src/port/arm/armv8-kyber-asm_c.c)
                   list(APPEND LIB_SOURCES wolfcrypt/src/port/arm/armv8-kyber-asm.S)
              endif()
         endif()
