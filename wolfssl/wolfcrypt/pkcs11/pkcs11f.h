...
(
  ...
  CK_BYTE_PTR pCiphertext,       /* the wrapped key */          /* TODO: was pCiphertextKey , not matching with length variable */
...
(
  CK_SESSION_HANDLE hSession,             /* the session's handle */
  CK_ULONG /* CK_SESSION_VALIDATION_FLAGS_TYPE */ type,  /* which state of flags */ /* CK_SESSION_VALIDATION_FLAGS_TYPE currently not in header !!! */
  CK_FLAGS * pFlags                     /* validation flags */ /* CK_FLAGS_PTR currently not in header !!! */
);
#endif
