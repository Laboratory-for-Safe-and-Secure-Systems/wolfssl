...
enum Ctc_SigType {
    ...
    CTC_FALCON_LEVEL1 = 278,
    CTC_FALCON_LEVEL5 = 281,
    ...
    CTC_SPHINCS_FAST_LEVEL1  = 290,
    CTC_SPHINCS_FAST_LEVEL3  = 288,
    CTC_SPHINCS_FAST_LEVEL5  = 289,
    CTC_SPHINCS_SMALL_LEVEL1 = 293,
    CTC_SPHINCS_SMALL_LEVEL3 = 292,
    CTC_SPHINCS_SMALL_LEVEL5 = 291
};
